  ...
  return (
    <>
      ...
      <div className={`${t.bar} text-white text-[11px] md:text-xs`}>
        <div className="mx-auto max-w-[1700px] px-6 py-2 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-100 shadow-sm">
        <div className="mx-auto max-w-[1700px] px-6 py-3 flex items-center justify-between gap-4">
